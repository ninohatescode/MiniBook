insert into HRM(hrm_user_name,hrm_password)
values
('admin','admin')
...
insert into Publisher(publisher_id, publisher_phone, publisher_mail, publisher_address, publisher_name)
values
...
insert into Author(author_id, author_name, author_address, author_mail, author_descrip)
values
...
insert into Role(author_id, book_id, _role)
values
(1,1, N'Tác giả'),
(2,2, N'Tác giả'),
(3,3, N'Tác giả'),
...
insert into Book(book_id, book_name, book_price, book_quantity, book_descrip, book_image, book_release, book_view, book_sale, publisher_id, category_id)
values
